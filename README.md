...
The Data-Retrieval-Automation is a set of Python scripts (`data-retrieval-automation-mno.py` and `data-retrieval-automation-iptsp.py`) that automate a series of tasks using the Selenium web automation framework. It is created to interact with a specific web application, automate login, and download reports.
